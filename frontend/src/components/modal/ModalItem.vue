        ...
        <div class="skills">
          ...
          <div v-if="modalStore.employeeData">
            <SkillComponent
              ...
              v-for="(skill, index) in modalStore.employeeData.skills"
              :key="skill.index"
              :skill="skill"
              :index="index"
            />
          ...
          <div v-if="employeesStore.newEmployee">
            <SkillComponent
              @remove-skill="removeSkill"
              v-for="(skill, index) in employeesStore.newEmployee.skills"
              :key="skill.index"
              :skill="skill"
              :index="index"
            />
